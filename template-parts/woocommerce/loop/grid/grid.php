...
$animation_class = $animation_class ?? ($settings['animation_class'] ?? 'default-grid-thumb');
    ...
    <div class="product-item-inner">
        <div class="product-thumbnail-outer position-relative">
            <div class="product-thumbnail-wrapper overflow-hidden position-relative">
                <?php t888f_animation_thumbnail_product(get_the_ID(), $size, $animation_class); ?>
                <?php if ($is_new): ?>
                ...
                ?>
                    <span class="product-badge sale">-<?php echo esc_attr($discount); ?><?php echo esc_html__('%', 'nebon'); ?></span>
                <?php endif; ?>
