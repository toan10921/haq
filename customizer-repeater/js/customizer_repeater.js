...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            var image_only_url = jQuery(this).find('.custom-media-url_image_only').val();
            var file_only_url = jQuery(this).find('.custom-media-url-file-only').val();
            var file_url = jQuery(this).find('.custom-media-url-file').val();
            var icon_only_value = jQuery(this).find('.icp-only').val();
            ...
            if (text !== '' || image_url !== '' || image_only_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '' || file_only_url !== '' || file_url !== '') {
                values.push({
                    'icon_value': (choice === 'customizer_repeater_none' ? '' : icon_value),
                    'icon_only_value': (choice === 'customizer_repeater_none' ? '' : icon_only_value),
                    'color': color,
                    'color2': color2,
                    ...
                    'image_only_url': (choice === 'customizer_repeater_none' ? '' : image_only_url),
                    'file_only_url': (choice === 'customizer_repeater_none' ? '' : file_only_url),
                    'file_url': (choice === 'customizer_repeater_none' ? '' : file_url),
                    'choice': choice,
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('change', '.customizer-repeater-image-choice', function () {
        ...
        if (jQuery(this).val() === 'customizer_repeater_file') {
            jQuery(this).parent().parent().find('.social-repeater-general-control-icon').hide();
            jQuery(this).parent().parent().find('.customizer-repeater-file-control').show();
            jQuery(this).parent().parent().find('.customizer-repeater-color-control').prev().prev().hide();
            jQuery(this).parent().parent().find('.customizer-repeater-color-control').hide();
        }
    ...
    jQuery('.custom-media-url_image_only').on('change', function () {
        customizer_repeater_refresh_general_control_values();
        return false;
    });
    jQuery('.custom-media-url-file-only').on('change', function () {
        customizer_repeater_refresh_general_control_values();
        return false;
    });
    jQuery('.custom-media-url-file').on('change', function () {
        customizer_repeater_refresh_general_control_values();
        return false;
    });
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
                ...
                field.find('.input-group-addon').find('.lab').attr('class', 'lab');
                ...
                /*Remove value from media field*/
                field.find('.custom-media-url-file').val('');      
                field.find('.custom-media-url-file-only').val('');  
                field.find('.customizer-repeater-file-control').hide(); 
