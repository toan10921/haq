...
$right_title = $right_title ?? __('Pet Toys', 'nebon');
...
<div class="t888-pet-mega-menu" style="--pet-menu-bg: <?php echo esc_attr($box_background); ?>;">
    ...
    <?php if (!empty($bottom_banner_image_url)): ?>
        <div class="pet-mega-banner-wrap">
            <a href="<?php echo esc_url($bottom_banner_link_url); ?>"<?php echo $bottom_banner_target . $bottom_banner_nofollow; ?> class="pet-mega-banner-link">
                <img src="<?php echo esc_url($bottom_banner_image_url); ?>" alt="<?php esc_attr_e('Pet sale banner', 'nebon'); ?>" class="pet-mega-banner-image">
            </a>
        </div>
    <?php endif; ?>
</div>
