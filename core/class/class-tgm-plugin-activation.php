		...
		if ( isset( $_GET['page'] ) && $tgmpa_instance->menu === $_GET['page'] ) {
			...
			if ( ! class_exists( 'TGMPA_Bulk_Installer_Skin' ) ) {
				...
				class TGMPA_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
					 ...
					 * success strings.
					 * overwrites the parent method to fix afer method wordpress php 8.x compatibility
					 *
					 * @since 2.2.0
					 *
					 * @param string $title Unused in this implementation.
						...
						if ($this->result && ! is_wp_error($this->result)) {
							if (! $this->error) {
								echo '<div class="updated js-update-details" data-update-details="progress-' . esc_attr($this->upgrader->update_current) . '">' .
									...
									' <button type="button" class="hide-if-no-js button-link js-update-details-toggle" aria-expanded="false">' . __('More details.', 'nebon') . '<span class="dashicons dashicons-arrow-down" aria-hidden="true"></span></button>' .
									'</p></div>';
							}
